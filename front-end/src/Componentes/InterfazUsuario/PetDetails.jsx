...
// Main component
export const PetDetails = ({ datas, closeModal }) => {
    const namePro = gen => {
            ...
            <div className="pet-modal-content" onClick={e => e.stopPropagation()}>
                ...
                <section className="info-card">
                    ...
                    <div className="info-grid">
                        ...
                        <div className="info-item">
                            ...
                            <span className="info-value">{datas.esp_mas || 'No registrado'}</span>
                        </div>
                        <div className="info-item">
                ...
                <section className="info-card">
                    ...
                    <div className="info-item">
                        ...
                        <span className="info-value">{datas.ali_mas || 'No especificada'}</span>
                    </div>
                    <div className="info-item">
